    ...
    try {
        ...
        await pool.query(
            `UPDATE projects SET 
                ...
                impact_label_2 = ?, thumb_icon = ?, thumb_color = ?, detail_link = ? 
             WHERE id = ?`,
            [title, category, badge, sub_title, description, JSON.stringify(tags), impact_value_1, impact_label_1, impact_value_2, impact_label_2, thumb_icon, thumb_color, detail_link, id]
        );
